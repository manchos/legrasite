...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('design_work', '0003_designworkpage_sequence_number'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='designworkpage',
            name='description',
            field=wagtail.core.fields.RichTextField(blank=True, help_text='Text to describe the page', verbose_name='Описание'),
        ),
        migrations.AlterField(
            model_name='designworkpage',
            name='image',
            field=models.ForeignKey(blank=True, help_text='Landscape mode only; horizontal width between 1000px and 3000px.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image', verbose_name='Изображение'),
        ),
    ]
